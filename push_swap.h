...
/*   Updated: 2026/09/22 03:54:25 by mbrunial         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					adaptive(t_dll **stack1, t_dll **stack2,
							t_options *options, int len_stack1);
...
void					swap_ss(t_dll **head1, t_dll **head2,
							t_options *options);

// push
void					push_pa(t_dll **head1, t_dll **head2,
							t_options *options);
void					push_pb(t_dll **head1, t_dll **head2,
							t_options *options);

// rotate
void					rotate_ra(t_dll **head, t_options *options);
void					rotate_rb(t_dll **head, t_options *options);
void					rotate_rr(t_dll **head1, t_dll **head2,
							t_options *options);
...
// validate_args.c
int						validate_args(t_options *options, int argc,
							char **argv);
